        ...
        <div className={styles.categoryContainer}>
            ...
            <div className={`${styles.card} ${styles.warrantyCard}`}>
                <div className={styles.cardContent}>
                    ...
                    <p className={styles.productSubtitle}>
                        Every gadget comes with our trusted 1 month warranty and after-sales support. 
            ...
            <div className={`${styles.card} ${styles.qualityCard}`}>
                <div className={styles.cardContent}>
                    ...
                    <p className={styles.productSubtitle}>
                        Every device goes through a 30+ point quality check to ensure it's fully 
                        functional and ready for use. Preowned, Not Compromised.
                    </p>
                </div>
            </div>
            ...
            <div className={`${styles.card} ${styles.preownedCard}`}>
                <div className={styles.cardContent}>
                    <h2 className={styles.productTitle}>Looks Like New, Feels Like New</h2>
                    <p className={styles.productSubtitle}>
            ...
            <div className={`${styles.card} ${styles.customerCard}`}>
                <div className={styles.cardContent}>
                    ...
                    <p className={styles.productSubtitle}>
                        Join a growing community of smart buyers and sellers who trust Preown 
                        for premium pre-owned gadgets.
                    </p>
                </div>
            </div>
        </div>
