...
// //       <motion.div
// //         ref={sectionRef}
// //         className={`pl-5 md:pl-0 ${WRAPPER}`}
...
// //               <div
// //                 ref={scrollRef}
// //                 className="grid grid-flow-col auto-cols-[86%] max-[380px]:auto-cols-[90%] gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory px-1 py-1 md:flex md:auto-cols-auto md:w-auto md:px-0 md:pb-4 scroll-pl-1 scroll-pr-1 md:scroll-pl-5 md:scroll-pr-5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
...
//         id="explore"
//       >
//         {/* Heading row — heading left, scroll arrows right (desktop only) */}
...
//             <div className="hidden md:flex items-center gap-2 md:gap-6 xl:translate-y-6 2xl:translate-y-6 flex-shrink-0">
//               <button
//                 onClick={scrollLeft}
//                 className=" "
//                 aria-label="Scroll left"
//               >
//                 <FiArrowLeft size={18} className="text-black" />
//               </button>
//               <button
//                 onClick={scrollRight}
//                 className=""
//                 aria-label="Scroll right"
//               >
//                 <FiArrowRight size={18} className="text-black" />
//               </button>
//             </div>
//           )}
//         </div>
