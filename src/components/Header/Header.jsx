...
//   return (
//     // NOT sticky here — just a normal wrapper, no top/z classes
//     <header
//       id="site-header"
//       className="page-wrapper w-full bg-white relative z-50"
//     >
//       {/* STICKY top bar — logo, search, user, cart stay fixed on scroll */}
//       <div className="sticky top-0 z-50 bg-white">
//         <div className="md:max-w-6xl xl:max-w-[1300px]! 2xl:max-w-[1400px] mx-auto px-6 md:px-10 xl:px-10 2xl:px-0">
...
//       {/* Category Nav Row — NOT sticky, scrolls away normally with the page */}
//       <div className="md:max-w-6xl xl:max-w-[1300px]! 2xl:max-w-[1400px] mx-auto px-6 md:px-10 xl:px-10 2xl:px-0">
