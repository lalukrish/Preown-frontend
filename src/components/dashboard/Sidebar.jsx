...
//   FiShield, FiCreditCard, FiList, FiChevronRight,
// } from "react-icons/fi";
...
//   const isPinned  = useRef(false);       // clicked open → stays open
...
//   return (
//     <aside
//       style={{ width: isOpen ? OPEN_W : CLOSE_W }}
//       className="hidden md:flex flex-col fixed left-0 top-0 bottom-0 bg-white border-r border-gray-100 z-40 transition-[width] duration-300 ease-in-out overflow-visible"
//       onMouseEnter={handleMouseEnter}
//       onMouseLeave={handleMouseLeave}
//     >
//       {/* ── Inner area (clips content to sidebar width) ── */}
...
//         {/* User */}
//         <div className={`border-t border-gray-100 p-3 flex items-center gap-3 flex-shrink-0 ${!isOpen ? "justify-center" : ""}`}>
...
//               <p className="text-sm font-semibold text-gray-800 truncate">Rahul Kumar</p>
...
// const OPEN_W = 256; // px when expanded
// const CLOSE_W = 68; // px when collapsed
...
//     setIsOpen(next);
//     const el = document.getElementById("dash-content");
//     if (el) el.style.marginLeft = (next ? OPEN_W : CLOSE_W) + "px";
//   };
...
//       className="hidden md:flex flex-col fixed left-0 top-0 bottom-0 bg-white border-r border-gray-100 z-40 transition-[width] duration-300 ease-in-out overflow-visible"
//     >
//       {/* ── Inner scroll area (clips to sidebar width) ── */}
//       <div className="flex flex-col h-full overflow-hidden">
//         {/* Logo row */}
//         <div className="flex items-center h-16 border-b border-gray-100 px-4 flex-shrink-0 overflow-hidden">
//           {isOpen ? (
...
//         {/* User */}
//         <div
//           className={`border-t border-gray-100 p-3 flex items-center gap-3 flex-shrink-0 ${
...
//       {/* ── Toggle tab — pinned to right edge, vertically centered ── */}
//       <button
//         onClick={toggle}
//         aria-label={isOpen ? "Collapse sidebar" : "Expand sidebar"}
//         className="absolute top-1/3 -translate-y-1/3 -right-4 z-50
//           w-4 h-12 bg-white border border-gray-200 rounded-r-lg
//           flex items-center justify-center
//           text-gray-400 hover:text-orange-500 hover:border-orange-300
//           transition-colors shadow-sm cursor-pointer"
