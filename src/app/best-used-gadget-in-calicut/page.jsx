...
export async function generateMetadata() {
  const seoData = await fetchSEOData('gadget-in-calicut');
  return generateMetadataFromSEO(
    seoData,
    'Best Used Gadget in Calicut - Preown by applebae',
    'Discover the best pre-owned gadgets in Calicut at Preown by applebae. We offer premium phones, tablets, laptops, and accessories at unbeatable prices.',
    '/best-used-gadget-in-calicut'
  );
}

export default async function BestUsedGadgetCalicutPage() {
  const [seoData, gadgets] = await Promise.all([
    fetchSEOData('gadget-in-calicut'),
    fetchGadgetEntries('gadget-in-calicuts'),
  ]);
    ...
    <>
      ...
      <div className={styles.page}>
        <section className={styles.hero}>
          <div className={styles.container}>
            ...
            <p className={styles.mainDescription}>
              Discover the best pre-owneds gadgets in Calicut at Preown by applebae. We offer premium
        ...
        <section className={styles.ctaSection}>
          <div className={styles.container}>
            <h2 className={styles.ctaTitle}>Ready to Find Your Perfect Gadget in Calicut?</h2>
            <p className={styles.ctaDescription}>
              Browse our collection of premium pre-owned phones and gadgets available in Calicut.
            </p>
